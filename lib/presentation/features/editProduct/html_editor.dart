...
class AppHtmlEditor extends StatefulWidget {
  const AppHtmlEditor({Key? key, required this.title}) : super(key: key);
...
class _HtmlEditorExampleState extends State<AppHtmlEditor> {
  String result = '';
          ...
          actions: [
            IconButton(
                ...
                onPressed: () async {
                  ...
                  //   Navigator.of(context).pop({'html': html});
                  //   return;
                  // }
